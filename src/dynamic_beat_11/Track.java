...
public class Track {
	...
	// Track 우클릭 sourse - generals getters & setters - selected all - generate
	...
	// 생성자 추가 : track을 이용해서 새로운 변수를 만들어줄 때 한번에 내부 변수들을 초기화해주는 기능을 하는 메소드
	// Track 우클릭 sourse - generals constructor using fields - selected all - generate
